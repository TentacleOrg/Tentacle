...
class PersonApi {
  ...
  Future<Response<PersonPersonIdCombinedCreditsGet200Response>> personPersonIdCombinedCreditsGet({ 
    ...
    final _path = r'/person/{personId}/combined_credits'.replaceAll('{' r'personId' '}', encodeQueryParameter(_serializers, personId, const FullType(num)).toString());
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PersonPersonIdCombinedCreditsGet200Response),
  ...
  Future<Response<PersonDetails>> personPersonIdGet({ 
    ...
    final _path = r'/person/{personId}'.replaceAll('{' r'personId' '}', encodeQueryParameter(_serializers, personId, const FullType(num)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
