...
class TvApi {
  ...
  Future<Response<TvDetails>> tvTvIdGet({ 
    ...
    final _path = r'/tv/{tvId}'.replaceAll('{' r'tvId' '}', encodeQueryParameter(_serializers, tvId, const FullType(num)).toString());
  ...
  Future<Response<TvTvIdRatingsGet200Response>> tvTvIdRatingsGet({ 
    ...
    final _path = r'/tv/{tvId}/ratings'.replaceAll('{' r'tvId' '}', encodeQueryParameter(_serializers, tvId, const FullType(num)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<DiscoverTvGet200Response>> tvTvIdRecommendationsGet({ 
    ...
    final _path = r'/tv/{tvId}/recommendations'.replaceAll('{' r'tvId' '}', encodeQueryParameter(_serializers, tvId, const FullType(num)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<Season>> tvTvIdSeasonSeasonIdGet({ 
    ...
    final _path = r'/tv/{tvId}/season/{seasonId}'.replaceAll('{' r'tvId' '}', encodeQueryParameter(_serializers, tvId, const FullType(num)).toString()).replaceAll('{' r'seasonId' '}', encodeQueryParameter(_serializers, seasonId, const FullType(num)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<DiscoverTvGet200Response>> tvTvIdSimilarGet({ 
    ...
    final _path = r'/tv/{tvId}/similar'.replaceAll('{' r'tvId' '}', encodeQueryParameter(_serializers, tvId, const FullType(num)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
