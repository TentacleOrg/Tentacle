...
/// * [data] 
@BuiltValue()
abstract class DiscoverSlider implements Built<DiscoverSlider, DiscoverSliderBuilder> {
  ...
  factory DiscoverSlider([void updates(DiscoverSliderBuilder b)]) = _$DiscoverSlider;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DiscoverSliderBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DiscoverSlider> get serializer => _$DiscoverSliderSerializer();
}

class _$DiscoverSliderSerializer implements PrimitiveSerializer<DiscoverSlider> {
  @override
