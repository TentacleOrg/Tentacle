...
/// * [externalUrl] 
@BuiltValue()
abstract class TautulliSettings implements Built<TautulliSettings, TautulliSettingsBuilder> {
  ...
  factory TautulliSettings([void updates(TautulliSettingsBuilder b)]) = _$TautulliSettings;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(TautulliSettingsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<TautulliSettings> get serializer => _$TautulliSettingsSerializer();
}

class _$TautulliSettingsSerializer implements PrimitiveSerializer<TautulliSettings> {
  @override
