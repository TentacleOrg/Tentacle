...
/// * [sendSilently] 
@BuiltValue()
abstract class TelegramSettingsOptions implements Built<TelegramSettingsOptions, TelegramSettingsOptionsBuilder> {
  ...
  factory TelegramSettingsOptions([void updates(TelegramSettingsOptionsBuilder b)]) = _$TelegramSettingsOptions;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(TelegramSettingsOptionsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<TelegramSettingsOptions> get serializer => _$TelegramSettingsOptionsSerializer();
}

class _$TelegramSettingsOptionsSerializer implements PrimitiveSerializer<TelegramSettingsOptions> {
  @override
  final Iterable<Type> types = const [TelegramSettingsOptions, _$TelegramSettingsOptions];
