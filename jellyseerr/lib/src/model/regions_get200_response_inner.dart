...
/// * [englishName] 
@BuiltValue()
abstract class RegionsGet200ResponseInner implements Built<RegionsGet200ResponseInner, RegionsGet200ResponseInnerBuilder> {
  ...
  factory RegionsGet200ResponseInner([void updates(RegionsGet200ResponseInnerBuilder b)]) = _$RegionsGet200ResponseInner;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RegionsGet200ResponseInnerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<RegionsGet200ResponseInner> get serializer => _$RegionsGet200ResponseInnerSerializer();
}

class _$RegionsGet200ResponseInnerSerializer implements PrimitiveSerializer<RegionsGet200ResponseInner> {
  @override
  final Iterable<Type> types = const [RegionsGet200ResponseInner, _$RegionsGet200ResponseInner];
