...
/// * [releaseDates] 
@BuiltValue()
abstract class MovieDetailsReleasesResultsInner implements Built<MovieDetailsReleasesResultsInner, MovieDetailsReleasesResultsInnerBuilder> {
  ...
  BuiltList<MovieDetailsReleasesResultsInnerReleaseDatesInner>? get releaseDates;

  MovieDetailsReleasesResultsInner._();

  factory MovieDetailsReleasesResultsInner([void updates(MovieDetailsReleasesResultsInnerBuilder b)]) = _$MovieDetailsReleasesResultsInner;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MovieDetailsReleasesResultsInnerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<MovieDetailsReleasesResultsInner> get serializer => _$MovieDetailsReleasesResultsInnerSerializer();
}

class _$MovieDetailsReleasesResultsInnerSerializer implements PrimitiveSerializer<MovieDetailsReleasesResultsInner> {
  @override
  final Iterable<Type> types = const [MovieDetailsReleasesResultsInner, _$MovieDetailsReleasesResultsInner];
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.releaseDates != null) {
      ...
      yield serializers.serialize(
        object.releaseDates,
        specifiedType: const FullType(BuiltList, [FullType(MovieDetailsReleasesResultsInnerReleaseDatesInner)]),
      );
    }
  }
