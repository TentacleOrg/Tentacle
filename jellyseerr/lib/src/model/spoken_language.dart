...
/// * [name] 
@BuiltValue()
abstract class SpokenLanguage implements Built<SpokenLanguage, SpokenLanguageBuilder> {
  ...
  factory SpokenLanguage([void updates(SpokenLanguageBuilder b)]) = _$SpokenLanguage;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SpokenLanguageBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SpokenLanguage> get serializer => _$SpokenLanguageSerializer();
}

class _$SpokenLanguageSerializer implements PrimitiveSerializer<SpokenLanguage> {
  @override
