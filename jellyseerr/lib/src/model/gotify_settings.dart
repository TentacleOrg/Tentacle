...
/// * [options] 
@BuiltValue()
abstract class GotifySettings implements Built<GotifySettings, GotifySettingsBuilder> {
  ...
  factory GotifySettings([void updates(GotifySettingsBuilder b)]) = _$GotifySettings;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(GotifySettingsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<GotifySettings> get serializer => _$GotifySettingsSerializer();
}

class _$GotifySettingsSerializer implements PrimitiveSerializer<GotifySettings> {
  @override
