...
/// * [baseUrl] 
@BuiltValue()
abstract class SettingsSonarrTestPostRequest implements Built<SettingsSonarrTestPostRequest, SettingsSonarrTestPostRequestBuilder> {
  ...
  factory SettingsSonarrTestPostRequest([void updates(SettingsSonarrTestPostRequestBuilder b)]) = _$SettingsSonarrTestPostRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SettingsSonarrTestPostRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SettingsSonarrTestPostRequest> get serializer => _$SettingsSonarrTestPostRequestSerializer();
}

class _$SettingsSonarrTestPostRequestSerializer implements PrimitiveSerializer<SettingsSonarrTestPostRequest> {
  @override
  final Iterable<Type> types = const [SettingsSonarrTestPostRequest, _$SettingsSonarrTestPostRequest];
