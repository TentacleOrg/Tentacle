...
/// * [options] 
@BuiltValue()
abstract class TelegramSettings implements Built<TelegramSettings, TelegramSettingsBuilder> {
  ...
  factory TelegramSettings([void updates(TelegramSettingsBuilder b)]) = _$TelegramSettings;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(TelegramSettingsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<TelegramSettings> get serializer => _$TelegramSettingsSerializer();
}

class _$TelegramSettingsSerializer implements PrimitiveSerializer<TelegramSettings> {
  @override
