...
/// * [profileName] 
@BuiltValue()
abstract class LunaSeaSettingsOptions implements Built<LunaSeaSettingsOptions, LunaSeaSettingsOptionsBuilder> {
  ...
  factory LunaSeaSettingsOptions([void updates(LunaSeaSettingsOptionsBuilder b)]) = _$LunaSeaSettingsOptions;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(LunaSeaSettingsOptionsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<LunaSeaSettingsOptions> get serializer => _$LunaSeaSettingsOptionsSerializer();
}

class _$LunaSeaSettingsOptionsSerializer implements PrimitiveSerializer<LunaSeaSettingsOptions> {
  @override
  final Iterable<Type> types = const [LunaSeaSettingsOptions, _$LunaSeaSettingsOptions];
