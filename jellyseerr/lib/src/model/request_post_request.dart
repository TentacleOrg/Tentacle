...
/// * [userId] 
@BuiltValue()
abstract class RequestPostRequest implements Built<RequestPostRequest, RequestPostRequestBuilder> {
  ...
  factory RequestPostRequest([void updates(RequestPostRequestBuilder b)]) = _$RequestPostRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RequestPostRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<RequestPostRequest> get serializer => _$RequestPostRequestSerializer();
}

class _$RequestPostRequestSerializer implements PrimitiveSerializer<RequestPostRequest> {
  @override
...
class RequestPostRequestMediaTypeEnum extends EnumClass {
  ...
  static const RequestPostRequestMediaTypeEnum movie = _$requestPostRequestMediaTypeEnum_movie;
  @BuiltValueEnumConst(wireName: r'tv')
  static const RequestPostRequestMediaTypeEnum tv = _$requestPostRequestMediaTypeEnum_tv;

  static Serializer<RequestPostRequestMediaTypeEnum> get serializer => _$requestPostRequestMediaTypeEnumSerializer;

  const RequestPostRequestMediaTypeEnum._(String name): super(name);

  static BuiltSet<RequestPostRequestMediaTypeEnum> get values => _$requestPostRequestMediaTypeEnumValues;
  static RequestPostRequestMediaTypeEnum valueOf(String name) => _$requestPostRequestMediaTypeEnumValueOf(name);
}
