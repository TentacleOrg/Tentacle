...
/// * [enableMentions] 
@BuiltValue()
abstract class DiscordSettingsOptions implements Built<DiscordSettingsOptions, DiscordSettingsOptionsBuilder> {
  ...
  factory DiscordSettingsOptions([void updates(DiscordSettingsOptionsBuilder b)]) = _$DiscordSettingsOptions;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DiscordSettingsOptionsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DiscordSettingsOptions> get serializer => _$DiscordSettingsOptionsSerializer();
}

class _$DiscordSettingsOptionsSerializer implements PrimitiveSerializer<DiscordSettingsOptions> {
  @override
  final Iterable<Type> types = const [DiscordSettingsOptions, _$DiscordSettingsOptions];
