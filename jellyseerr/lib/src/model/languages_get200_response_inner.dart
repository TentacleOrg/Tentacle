...
/// * [name] 
@BuiltValue()
abstract class LanguagesGet200ResponseInner implements Built<LanguagesGet200ResponseInner, LanguagesGet200ResponseInnerBuilder> {
  ...
  factory LanguagesGet200ResponseInner([void updates(LanguagesGet200ResponseInnerBuilder b)]) = _$LanguagesGet200ResponseInner;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(LanguagesGet200ResponseInnerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<LanguagesGet200ResponseInner> get serializer => _$LanguagesGet200ResponseInnerSerializer();
}

class _$LanguagesGet200ResponseInnerSerializer implements PrimitiveSerializer<LanguagesGet200ResponseInner> {
  @override
  final Iterable<Type> types = const [LanguagesGet200ResponseInner, _$LanguagesGet200ResponseInner];
