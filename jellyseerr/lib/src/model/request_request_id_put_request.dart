...
/// * [userId] 
@BuiltValue()
abstract class RequestRequestIdPutRequest implements Built<RequestRequestIdPutRequest, RequestRequestIdPutRequestBuilder> {
  ...
  factory RequestRequestIdPutRequest([void updates(RequestRequestIdPutRequestBuilder b)]) = _$RequestRequestIdPutRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RequestRequestIdPutRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<RequestRequestIdPutRequest> get serializer => _$RequestRequestIdPutRequestSerializer();
}

class _$RequestRequestIdPutRequestSerializer implements PrimitiveSerializer<RequestRequestIdPutRequest> {
  @override
  final Iterable<Type> types = const [RequestRequestIdPutRequest, _$RequestRequestIdPutRequest];
...
class RequestRequestIdPutRequestMediaTypeEnum extends EnumClass {
  ...
  static const RequestRequestIdPutRequestMediaTypeEnum movie = _$requestRequestIdPutRequestMediaTypeEnum_movie;
  @BuiltValueEnumConst(wireName: r'tv')
  static const RequestRequestIdPutRequestMediaTypeEnum tv = _$requestRequestIdPutRequestMediaTypeEnum_tv;

  static Serializer<RequestRequestIdPutRequestMediaTypeEnum> get serializer => _$requestRequestIdPutRequestMediaTypeEnumSerializer;

  const RequestRequestIdPutRequestMediaTypeEnum._(String name): super(name);

  static BuiltSet<RequestRequestIdPutRequestMediaTypeEnum> get values => _$requestRequestIdPutRequestMediaTypeEnumValues;
  static RequestRequestIdPutRequestMediaTypeEnum valueOf(String name) => _$requestRequestIdPutRequestMediaTypeEnumValueOf(name);
}
