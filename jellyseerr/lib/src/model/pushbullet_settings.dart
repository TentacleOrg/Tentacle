...
/// * [options] 
@BuiltValue()
abstract class PushbulletSettings implements Built<PushbulletSettings, PushbulletSettingsBuilder> {
  ...
  factory PushbulletSettings([void updates(PushbulletSettingsBuilder b)]) = _$PushbulletSettings;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PushbulletSettingsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PushbulletSettings> get serializer => _$PushbulletSettingsSerializer();
}

class _$PushbulletSettingsSerializer implements PrimitiveSerializer<PushbulletSettings> {
  @override
