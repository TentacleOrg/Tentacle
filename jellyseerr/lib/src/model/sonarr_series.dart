...
/// * [addOptions] 
@BuiltValue()
abstract class SonarrSeries implements Built<SonarrSeries, SonarrSeriesBuilder> {
...
class _$SonarrSeriesSerializer implements PrimitiveSerializer<SonarrSeries> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.images != null) {
      ...
      yield serializers.serialize(
        object.images,
        specifiedType: const FullType(BuiltList, [FullType(SonarrSeriesImagesInner)]),
      );
    }
    ...
    if (object.seasons != null) {
      ...
      yield serializers.serialize(
        object.seasons,
        specifiedType: const FullType(BuiltList, [FullType(SonarrSeriesSeasonsInner)]),
      );
    }
    if (object.year != null) {
      yield r'year';
    ...
    if (object.ratings != null) {
      ...
      yield serializers.serialize(
        object.ratings,
        specifiedType: const FullType(BuiltList, [FullType(SonarrSeriesRatingsInner)]),
      );
    }
    ...
    if (object.addOptions != null) {
      ...
      yield serializers.serialize(
        object.addOptions,
        specifiedType: const FullType(BuiltList, [FullType(SonarrSeriesAddOptionsInner)]),
      );
    }
  }
