...
/// * [homepage] 
@BuiltValue()
abstract class PersonDetails implements Built<PersonDetails, PersonDetailsBuilder> {
  ...
  factory PersonDetails([void updates(PersonDetailsBuilder b)]) = _$PersonDetails;
