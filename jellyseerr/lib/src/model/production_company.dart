...
/// * [name] 
@BuiltValue()
abstract class ProductionCompany implements Built<ProductionCompany, ProductionCompanyBuilder> {
  ...
  factory ProductionCompany([void updates(ProductionCompanyBuilder b)]) = _$ProductionCompany;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ProductionCompanyBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ProductionCompany> get serializer => _$ProductionCompanySerializer();
}

class _$ProductionCompanySerializer implements PrimitiveSerializer<ProductionCompany> {
  @override
