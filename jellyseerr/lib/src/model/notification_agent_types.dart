...
/// * [webpush] 
@BuiltValue()
abstract class NotificationAgentTypes implements Built<NotificationAgentTypes, NotificationAgentTypesBuilder> {
  ...
  factory NotificationAgentTypes([void updates(NotificationAgentTypesBuilder b)]) = _$NotificationAgentTypes;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(NotificationAgentTypesBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<NotificationAgentTypes> get serializer => _$NotificationAgentTypesSerializer();
}

class _$NotificationAgentTypesSerializer implements PrimitiveSerializer<NotificationAgentTypes> {
  @override
  final Iterable<Type> types = const [NotificationAgentTypes, _$NotificationAgentTypes];
