...
/// * [mediaId] 
@BuiltValue()
abstract class IssuePostRequest implements Built<IssuePostRequest, IssuePostRequestBuilder> {
  ...
  factory IssuePostRequest([void updates(IssuePostRequestBuilder b)]) = _$IssuePostRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IssuePostRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<IssuePostRequest> get serializer => _$IssuePostRequestSerializer();
}

class _$IssuePostRequestSerializer implements PrimitiveSerializer<IssuePostRequest> {
  @override
