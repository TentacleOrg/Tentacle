...
/// * [monitored] 
@BuiltValue()
abstract class SonarrSeriesSeasonsInner implements Built<SonarrSeriesSeasonsInner, SonarrSeriesSeasonsInnerBuilder> {
  ...
  factory SonarrSeriesSeasonsInner([void updates(SonarrSeriesSeasonsInnerBuilder b)]) = _$SonarrSeriesSeasonsInner;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SonarrSeriesSeasonsInnerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SonarrSeriesSeasonsInner> get serializer => _$SonarrSeriesSeasonsInnerSerializer();
}

class _$SonarrSeriesSeasonsInnerSerializer implements PrimitiveSerializer<SonarrSeriesSeasonsInner> {
  @override
  final Iterable<Type> types = const [SonarrSeriesSeasonsInner, _$SonarrSeriesSeasonsInner];
