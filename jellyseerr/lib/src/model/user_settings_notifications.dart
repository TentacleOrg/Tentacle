...
@BuiltValue()
abstract class UserSettingsNotifications implements Built<UserSettingsNotifications, UserSettingsNotificationsBuilder> {
  ...
  factory UserSettingsNotifications([void updates(UserSettingsNotificationsBuilder b)]) = _$UserSettingsNotifications;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UserSettingsNotificationsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UserSettingsNotifications> get serializer => _$UserSettingsNotificationsSerializer();
}

class _$UserSettingsNotificationsSerializer implements PrimitiveSerializer<UserSettingsNotifications> {
  @override
  final Iterable<Type> types = const [UserSettingsNotifications, _$UserSettingsNotifications];
