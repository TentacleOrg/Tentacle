...
@BuiltValue()
abstract class SonarrSeriesAddOptionsInner implements Built<SonarrSeriesAddOptionsInner, SonarrSeriesAddOptionsInnerBuilder> {
  ...
  factory SonarrSeriesAddOptionsInner([void updates(SonarrSeriesAddOptionsInnerBuilder b)]) = _$SonarrSeriesAddOptionsInner;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SonarrSeriesAddOptionsInnerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SonarrSeriesAddOptionsInner> get serializer => _$SonarrSeriesAddOptionsInnerSerializer();
}

class _$SonarrSeriesAddOptionsInnerSerializer implements PrimitiveSerializer<SonarrSeriesAddOptionsInner> {
  @override
  final Iterable<Type> types = const [SonarrSeriesAddOptionsInner, _$SonarrSeriesAddOptionsInner];
