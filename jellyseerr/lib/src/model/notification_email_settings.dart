...
/// * [options] 
@BuiltValue()
abstract class NotificationEmailSettings implements Built<NotificationEmailSettings, NotificationEmailSettingsBuilder> {
  ...
  factory NotificationEmailSettings([void updates(NotificationEmailSettingsBuilder b)]) = _$NotificationEmailSettings;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(NotificationEmailSettingsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<NotificationEmailSettings> get serializer => _$NotificationEmailSettingsSerializer();
}

class _$NotificationEmailSettingsSerializer implements PrimitiveSerializer<NotificationEmailSettings> {
  @override
  final Iterable<Type> types = const [NotificationEmailSettings, _$NotificationEmailSettings];
