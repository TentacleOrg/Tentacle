...
/// * [sound] 
@BuiltValue()
abstract class PushoverSettingsOptions implements Built<PushoverSettingsOptions, PushoverSettingsOptionsBuilder> {
  ...
  factory PushoverSettingsOptions([void updates(PushoverSettingsOptionsBuilder b)]) = _$PushoverSettingsOptions;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PushoverSettingsOptionsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PushoverSettingsOptions> get serializer => _$PushoverSettingsOptionsSerializer();
}

class _$PushoverSettingsOptionsSerializer implements PrimitiveSerializer<PushoverSettingsOptions> {
  @override
  final Iterable<Type> types = const [PushoverSettingsOptions, _$PushoverSettingsOptions];
