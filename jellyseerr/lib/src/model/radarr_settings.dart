...
/// * [preventSearch] 
@BuiltValue()
abstract class RadarrSettings implements Built<RadarrSettings, RadarrSettingsBuilder> {
  ...
  factory RadarrSettings([void updates(RadarrSettingsBuilder b)]) = _$RadarrSettings;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RadarrSettingsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<RadarrSettings> get serializer => _$RadarrSettingsSerializer();
}

class _$RadarrSettingsSerializer implements PrimitiveSerializer<RadarrSettings> {
  @override
