...
/// * [imdb] 
@BuiltValue()
abstract class MovieMovieIdRatingscombinedGet200Response implements Built<MovieMovieIdRatingscombinedGet200Response, MovieMovieIdRatingscombinedGet200ResponseBuilder> {
  ...
  factory MovieMovieIdRatingscombinedGet200Response([void updates(MovieMovieIdRatingscombinedGet200ResponseBuilder b)]) = _$MovieMovieIdRatingscombinedGet200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MovieMovieIdRatingscombinedGet200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<MovieMovieIdRatingscombinedGet200Response> get serializer => _$MovieMovieIdRatingscombinedGet200ResponseSerializer();
}

class _$MovieMovieIdRatingscombinedGet200ResponseSerializer implements PrimitiveSerializer<MovieMovieIdRatingscombinedGet200Response> {
  @override
  final Iterable<Type> types = const [MovieMovieIdRatingscombinedGet200Response, _$MovieMovieIdRatingscombinedGet200Response];
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.imdb != null) {
      ...
      yield serializers.serialize(
        object.imdb,
        specifiedType: const FullType(MovieMovieIdRatingscombinedGet200ResponseImdb),
      );
    }
  }
