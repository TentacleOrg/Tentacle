...
/// * [options] 
@BuiltValue()
abstract class PushoverSettings implements Built<PushoverSettings, PushoverSettingsBuilder> {
  ...
  factory PushoverSettings([void updates(PushoverSettingsBuilder b)]) = _$PushoverSettings;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PushoverSettingsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PushoverSettings> get serializer => _$PushoverSettingsSerializer();
}

class _$PushoverSettingsSerializer implements PrimitiveSerializer<PushoverSettings> {
  @override
