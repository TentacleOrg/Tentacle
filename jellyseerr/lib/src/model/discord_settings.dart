...
/// * [options] 
@BuiltValue()
abstract class DiscordSettings implements Built<DiscordSettings, DiscordSettingsBuilder> {
  ...
  factory DiscordSettings([void updates(DiscordSettingsBuilder b)]) = _$DiscordSettings;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DiscordSettingsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DiscordSettings> get serializer => _$DiscordSettingsSerializer();
}

class _$DiscordSettingsSerializer implements PrimitiveSerializer<DiscordSettings> {
  @override
