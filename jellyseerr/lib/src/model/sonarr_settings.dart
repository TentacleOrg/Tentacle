...
/// * [preventSearch] 
@BuiltValue()
abstract class SonarrSettings implements Built<SonarrSettings, SonarrSettingsBuilder> {
  ...
  factory SonarrSettings([void updates(SonarrSettingsBuilder b)]) = _$SonarrSettings;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SonarrSettingsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SonarrSettings> get serializer => _$SonarrSettingsSerializer();
}

class _$SonarrSettingsSerializer implements PrimitiveSerializer<SonarrSettings> {
  @override
