...
/// * [jsonPayload] 
@BuiltValue()
abstract class WebhookSettingsOptions implements Built<WebhookSettingsOptions, WebhookSettingsOptionsBuilder> {
  ...
  factory WebhookSettingsOptions([void updates(WebhookSettingsOptionsBuilder b)]) = _$WebhookSettingsOptions;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(WebhookSettingsOptionsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<WebhookSettingsOptions> get serializer => _$WebhookSettingsOptionsSerializer();
}

class _$WebhookSettingsOptionsSerializer implements PrimitiveSerializer<WebhookSettingsOptions> {
  @override
  final Iterable<Type> types = const [WebhookSettingsOptions, _$WebhookSettingsOptions];
