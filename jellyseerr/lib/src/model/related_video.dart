...
/// * [site] 
@BuiltValue()
abstract class RelatedVideo implements Built<RelatedVideo, RelatedVideoBuilder> {
...
class RelatedVideoTypeEnum extends EnumClass {
  ...
  static const RelatedVideoTypeEnum featurette = _$relatedVideoTypeEnum_featurette;
  @BuiltValueEnumConst(wireName: r'Opening Credits')
  static const RelatedVideoTypeEnum openingCredits = _$relatedVideoTypeEnum_openingCredits;
  @BuiltValueEnumConst(wireName: r'Behind the Scenes')
  static const RelatedVideoTypeEnum behindTheScenes = _$relatedVideoTypeEnum_behindTheScenes;
  @BuiltValueEnumConst(wireName: r'Bloopers')
  static const RelatedVideoTypeEnum bloopers = _$relatedVideoTypeEnum_bloopers;

  static Serializer<RelatedVideoTypeEnum> get serializer => _$relatedVideoTypeEnumSerializer;

  const RelatedVideoTypeEnum._(String name): super(name);

  static BuiltSet<RelatedVideoTypeEnum> get values => _$relatedVideoTypeEnumValues;
  static RelatedVideoTypeEnum valueOf(String name) => _$relatedVideoTypeEnumValueOf(name);
}
...
class RelatedVideoSiteEnum extends EnumClass {
  ...
  static Serializer<RelatedVideoSiteEnum> get serializer => _$relatedVideoSiteEnumSerializer;

  const RelatedVideoSiteEnum._(String name): super(name);

  static BuiltSet<RelatedVideoSiteEnum> get values => _$relatedVideoSiteEnumValues;
  static RelatedVideoSiteEnum valueOf(String name) => _$relatedVideoSiteEnumValueOf(name);
}
