...
/// * [nativeName] 
@BuiltValue()
abstract class WatchProviderRegion implements Built<WatchProviderRegion, WatchProviderRegionBuilder> {
  ...
  factory WatchProviderRegion([void updates(WatchProviderRegionBuilder b)]) = _$WatchProviderRegion;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(WatchProviderRegionBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<WatchProviderRegion> get serializer => _$WatchProviderRegionSerializer();
}

class _$WatchProviderRegionSerializer implements PrimitiveSerializer<WatchProviderRegion> {
  @override
  final Iterable<Type> types = const [WatchProviderRegion, _$WatchProviderRegion];
