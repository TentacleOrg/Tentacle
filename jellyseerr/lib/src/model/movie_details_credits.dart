...
/// * [crew] 
@BuiltValue()
abstract class MovieDetailsCredits implements Built<MovieDetailsCredits, MovieDetailsCreditsBuilder> {
  ...
  factory MovieDetailsCredits([void updates(MovieDetailsCreditsBuilder b)]) = _$MovieDetailsCredits;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MovieDetailsCreditsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<MovieDetailsCredits> get serializer => _$MovieDetailsCreditsSerializer();
}

class _$MovieDetailsCreditsSerializer implements PrimitiveSerializer<MovieDetailsCredits> {
  @override
  final Iterable<Type> types = const [MovieDetailsCredits, _$MovieDetailsCredits];
