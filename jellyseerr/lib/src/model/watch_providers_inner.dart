...
/// * [flatrate] 
@BuiltValue()
abstract class WatchProvidersInner implements Built<WatchProvidersInner, WatchProvidersInnerBuilder> {
  ...
  factory WatchProvidersInner([void updates(WatchProvidersInnerBuilder b)]) = _$WatchProvidersInner;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(WatchProvidersInnerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<WatchProvidersInner> get serializer => _$WatchProvidersInnerSerializer();
}

class _$WatchProvidersInnerSerializer implements PrimitiveSerializer<WatchProvidersInner> {
  @override
  final Iterable<Type> types = const [WatchProvidersInner, _$WatchProvidersInner];
