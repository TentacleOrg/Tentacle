...
/// * [options] 
@BuiltValue()
abstract class LunaSeaSettings implements Built<LunaSeaSettings, LunaSeaSettingsBuilder> {
  ...
  factory LunaSeaSettings([void updates(LunaSeaSettingsBuilder b)]) = _$LunaSeaSettings;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(LunaSeaSettingsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<LunaSeaSettings> get serializer => _$LunaSeaSettingsSerializer();
}

class _$LunaSeaSettingsSerializer implements PrimitiveSerializer<LunaSeaSettings> {
  @override
