...
/// * [message] 
@BuiltValue()
abstract class PlexConnection implements Built<PlexConnection, PlexConnectionBuilder> {
  ...
  factory PlexConnection([void updates(PlexConnectionBuilder b)]) = _$PlexConnection;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PlexConnectionBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PlexConnection> get serializer => _$PlexConnectionSerializer();
}

class _$PlexConnectionSerializer implements PrimitiveSerializer<PlexConnection> {
  @override
