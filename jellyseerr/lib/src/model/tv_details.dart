...
class _$TvDetailsSerializer implements PrimitiveSerializer<TvDetails> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.createdBy != null) {
      ...
      yield serializers.serialize(
        object.createdBy,
        specifiedType: const FullType(BuiltList, [FullType(TvDetailsCreatedByInner)]),
      );
    }
    ...
    if (object.productionCountries != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(BuiltList, [FullType(MovieDetailsProductionCountriesInner)]),
      );
    }
    ...
    if (object.watchProviders != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(BuiltList, [FullType(BuiltList, [FullType(WatchProvidersInner)])]),
      );
    }
  }
