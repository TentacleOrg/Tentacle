...
/// * [allowSelfSigned] 
@BuiltValue()
abstract class NotificationEmailSettingsOptions implements Built<NotificationEmailSettingsOptions, NotificationEmailSettingsOptionsBuilder> {
  ...
  factory NotificationEmailSettingsOptions([void updates(NotificationEmailSettingsOptionsBuilder b)]) = _$NotificationEmailSettingsOptions;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(NotificationEmailSettingsOptionsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<NotificationEmailSettingsOptions> get serializer => _$NotificationEmailSettingsOptionsSerializer();
}

class _$NotificationEmailSettingsOptionsSerializer implements PrimitiveSerializer<NotificationEmailSettingsOptions> {
  @override
  final Iterable<Type> types = const [NotificationEmailSettingsOptions, _$NotificationEmailSettingsOptions];
