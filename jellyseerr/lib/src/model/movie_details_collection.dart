...
/// * [backdropPath] 
@BuiltValue()
abstract class MovieDetailsCollection implements Built<MovieDetailsCollection, MovieDetailsCollectionBuilder> {
  ...
  factory MovieDetailsCollection([void updates(MovieDetailsCollectionBuilder b)]) = _$MovieDetailsCollection;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MovieDetailsCollectionBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<MovieDetailsCollection> get serializer => _$MovieDetailsCollectionSerializer();
}

class _$MovieDetailsCollectionSerializer implements PrimitiveSerializer<MovieDetailsCollection> {
  @override
  final Iterable<Type> types = const [MovieDetailsCollection, _$MovieDetailsCollection];
