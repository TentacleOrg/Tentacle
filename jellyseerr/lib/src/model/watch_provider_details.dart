...
/// * [name] 
@BuiltValue()
abstract class WatchProviderDetails implements Built<WatchProviderDetails, WatchProviderDetailsBuilder> {
  ...
  factory WatchProviderDetails([void updates(WatchProviderDetailsBuilder b)]) = _$WatchProviderDetails;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(WatchProviderDetailsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<WatchProviderDetails> get serializer => _$WatchProviderDetailsSerializer();
}

class _$WatchProviderDetailsSerializer implements PrimitiveSerializer<WatchProviderDetails> {
  @override
  final Iterable<Type> types = const [WatchProviderDetails, _$WatchProviderDetails];
