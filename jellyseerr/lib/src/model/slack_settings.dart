...
/// * [options] 
@BuiltValue()
abstract class SlackSettings implements Built<SlackSettings, SlackSettingsBuilder> {
  ...
  factory SlackSettings([void updates(SlackSettingsBuilder b)]) = _$SlackSettings;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SlackSettingsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SlackSettings> get serializer => _$SlackSettingsSerializer();
}
