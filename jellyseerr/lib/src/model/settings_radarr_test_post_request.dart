...
/// * [baseUrl] 
@BuiltValue()
abstract class SettingsRadarrTestPostRequest implements Built<SettingsRadarrTestPostRequest, SettingsRadarrTestPostRequestBuilder> {
  ...
  factory SettingsRadarrTestPostRequest([void updates(SettingsRadarrTestPostRequestBuilder b)]) = _$SettingsRadarrTestPostRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SettingsRadarrTestPostRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SettingsRadarrTestPostRequest> get serializer => _$SettingsRadarrTestPostRequestSerializer();
}

class _$SettingsRadarrTestPostRequestSerializer implements PrimitiveSerializer<SettingsRadarrTestPostRequest> {
  @override
  final Iterable<Type> types = const [SettingsRadarrTestPostRequest, _$SettingsRadarrTestPostRequest];
