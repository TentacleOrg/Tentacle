...
/// * [knownFor] 
@BuiltValue()
abstract class PersonResult implements Built<PersonResult, PersonResultBuilder> {
  ...
  static void _defaults(PersonResultBuilder b) => b
      ..mediaType = 'person';
...
class _$PersonResultSerializer implements PrimitiveSerializer<PersonResult> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.knownFor != null) {
      ...
      yield serializers.serialize(
        object.knownFor,
        specifiedType: const FullType(BuiltList, [FullType(PersonResultKnownForInner)]),
      );
    }
  }
