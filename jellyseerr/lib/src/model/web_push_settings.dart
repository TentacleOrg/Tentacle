...
/// * [types] 
@BuiltValue()
abstract class WebPushSettings implements Built<WebPushSettings, WebPushSettingsBuilder> {
  ...
  factory WebPushSettings([void updates(WebPushSettingsBuilder b)]) = _$WebPushSettings;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(WebPushSettingsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<WebPushSettings> get serializer => _$WebPushSettingsSerializer();
}

class _$WebPushSettingsSerializer implements PrimitiveSerializer<WebPushSettings> {
  @override
