...
/// tests for ShowApi
void main() {
  final instance = Tentacle().getShowApi();
  ...
  group(ShowApi, () {
    ...
    //
    //Future<BaseItemDtoQueryResult> getNextUp({ String userId, int startIndex, int limit, BuiltList<ItemFields> fields, String seriesId, String parentId, bool enableImages, int imageTypeLimit, BuiltList<ImageType> enableImageTypes, bool enableUserData, DateTime nextUpDateCutoff, bool enableTotalRecordCount, bool enableResumable, bool enableRewatching }) async
