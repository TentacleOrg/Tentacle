...
------------- | ------------- | -------------
[**getTrailers**](TrailerApi.md#gettrailers) | **GET** /Trailers | Finds movies and trailers similar to a given trailer.
...
final api = Tentacle().getTrailerApi();
...
final BuiltList<String> subtitleLanguages = ; // BuiltList<String> | Optional. If specified, results will be filtered based on subtitale language. This allows multiple, comma delimited values.
...
try {
    ...
    print('Exception when calling TrailerApi->getTrailers: $e\n');
}
```
 ...
 **subtitleLanguages** | [**BuiltList&lt;String&gt;**](String.md)| Optional. If specified, results will be filtered based on subtitale language. This allows multiple, comma delimited values. | [optional] 
