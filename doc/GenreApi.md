...
------------- | ------------- | -------------
[**getGenre**](GenreApi.md#getgenre) | **GET** /Genres/{genreName} | Gets a genre, by name.
[**getGenres**](GenreApi.md#getgenres) | **GET** /Genres | Gets all genres from a given item, folder, or the entire library.
...
final api = Tentacle().getGenreApi();
...
try {
    ...
    print('Exception when calling GenreApi->getGenre: $e\n');
}
```
...
try {
    ...
    print('Exception when calling GenreApi->getGenres: $e\n');
}
```
