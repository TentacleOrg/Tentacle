...
------------- | ------------- | -------------
[**getStudio**](StudioApi.md#getstudio) | **GET** /Studios/{name} | Gets a studio by name.
[**getStudios**](StudioApi.md#getstudios) | **GET** /Studios | Gets all studios from a given item, folder, or the entire library.
...
final api = Tentacle().getStudioApi();
...
try {
    ...
    print('Exception when calling StudioApi->getStudio: $e\n');
}
```
...
try {
    ...
    print('Exception when calling StudioApi->getStudios: $e\n');
}
```
