...
------------- | ------------- | -------------
[**getYear**](YearApi.md#getyear) | **GET** /Years/{year} | Gets a year.
[**getYears**](YearApi.md#getyears) | **GET** /Years | Get years.
...
try {
    ...
    print('Exception when calling YearApi->getYear: $e\n');
}
```
...
try {
    ...
    print('Exception when calling YearApi->getYears: $e\n');
}
```
