...
------------- | ------------- | -------------
[**getMovieRecommendations**](MovieApi.md#getmovierecommendations) | **GET** /Movies/Recommendations | Gets movie recommendations.
...
final api = Tentacle().getMovieApi();
...
try {
    ...
    print('Exception when calling MovieApi->getMovieRecommendations: $e\n');
}
```
