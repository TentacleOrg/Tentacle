...
------------- | ------------- | -------------
[**getAlbumArtists**](ArtistApi.md#getalbumartists) | **GET** /Artists/AlbumArtists | Gets all album artists from a given item, folder, or the entire library.
[**getArtistByName**](ArtistApi.md#getartistbyname) | **GET** /Artists/{name} | Gets an artist by name.
[**getArtists**](ArtistApi.md#getartists) | **GET** /Artists | Gets all artists from a given item, folder, or the entire library.
...
try {
    ...
    print('Exception when calling ArtistApi->getArtistByName: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ArtistApi->getArtists: $e\n');
}
```
