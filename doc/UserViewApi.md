...
------------- | ------------- | -------------
[**getGroupingOptions**](UserViewApi.md#getgroupingoptions) | **GET** /UserViews/GroupingOptions | Get user view grouping options.
[**getUserViews**](UserViewApi.md#getuserviews) | **GET** /UserViews | Get user views.
...
final api = Tentacle().getUserViewApi();
...
try {
    ...
    print('Exception when calling UserViewApi->getGroupingOptions: $e\n');
}
```
...
try {
    ...
    print('Exception when calling UserViewApi->getUserViews: $e\n');
}
```
