...
final api = Tentacle().getScheduledTaskApi();
...
try {
    ...
    print('Exception when calling ScheduledTaskApi->getTask: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ScheduledTaskApi->getTasks: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ScheduledTaskApi->startTask: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ScheduledTaskApi->stopTask: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ScheduledTaskApi->updateTask: $e\n');
}
```
