# tentacle.api.DisplayPreferenceApi
...
------------- | ------------- | -------------
[**getDisplayPreferences**](DisplayPreferenceApi.md#getdisplaypreferences) | **GET** /DisplayPreferences/{displayPreferencesId} | Get Display Preferences.
[**updateDisplayPreferences**](DisplayPreferenceApi.md#updatedisplaypreferences) | **POST** /DisplayPreferences/{displayPreferencesId} | Update Display Preferences.
...
final api = Tentacle().getDisplayPreferenceApi();
...
try {
    ...
    print('Exception when calling DisplayPreferenceApi->getDisplayPreferences: $e\n');
}
```
...
try {
    ...
    print('Exception when calling DisplayPreferenceApi->updateDisplayPreferences: $e\n');
}
```
