...
------------- | ------------- | -------------
[**getEpisodes**](ShowApi.md#getepisodes) | **GET** /Shows/{seriesId}/Episodes | Gets episodes for a tv season.
[**getNextUp**](ShowApi.md#getnextup) | **GET** /Shows/NextUp | Gets a list of next up episodes.
[**getSeasons**](ShowApi.md#getseasons) | **GET** /Shows/{seriesId}/Seasons | Gets seasons for a tv series.
[**getUpcomingEpisodes**](ShowApi.md#getupcomingepisodes) | **GET** /Shows/Upcoming | Gets a list of upcoming episodes.
...
try {
    ...
    print('Exception when calling ShowApi->getEpisodes: $e\n');
}
```
...
# **getNextUp**
> BaseItemDtoQueryResult getNextUp(userId, startIndex, limit, fields, seriesId, parentId, enableImages, imageTypeLimit, enableImageTypes, enableUserData, nextUpDateCutoff, enableTotalRecordCount, enableResumable, enableRewatching)
...
try {
    final response = api.getNextUp(userId, startIndex, limit, fields, seriesId, parentId, enableImages, imageTypeLimit, enableImageTypes, enableUserData, nextUpDateCutoff, enableTotalRecordCount, enableResumable, enableRewatching);
    print(response);
} catch on DioException (e) {
    print('Exception when calling ShowApi->getNextUp: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ShowApi->getSeasons: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ShowApi->getUpcomingEpisodes: $e\n');
}
```
