...
------------- | ------------- | -------------
[**getSuggestions**](SuggestionApi.md#getsuggestions) | **GET** /Items/Suggestions | Gets suggestions.
...
final api = Tentacle().getSuggestionApi();
...
try {
    ...
    print('Exception when calling SuggestionApi->getSuggestions: $e\n');
}
```
