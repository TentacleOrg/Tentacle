...
@BuiltValue()
abstract class UpdateUserItemDataDto implements Built<UpdateUserItemDataDto, UpdateUserItemDataDtoBuilder> {
  ...
  factory UpdateUserItemDataDto([void updates(UpdateUserItemDataDtoBuilder b)]) = _$UpdateUserItemDataDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpdateUserItemDataDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpdateUserItemDataDto> get serializer => _$UpdateUserItemDataDtoSerializer();
}

class _$UpdateUserItemDataDtoSerializer implements PrimitiveSerializer<UpdateUserItemDataDto> {
  @override
  final Iterable<Type> types = const [UpdateUserItemDataDto, _$UpdateUserItemDataDto];
