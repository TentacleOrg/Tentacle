...
@BuiltValue()
abstract class UpdatePlaylistUserDto implements Built<UpdatePlaylistUserDto, UpdatePlaylistUserDtoBuilder> {
  ...
  factory UpdatePlaylistUserDto([void updates(UpdatePlaylistUserDtoBuilder b)]) = _$UpdatePlaylistUserDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpdatePlaylistUserDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpdatePlaylistUserDto> get serializer => _$UpdatePlaylistUserDtoSerializer();
}

class _$UpdatePlaylistUserDtoSerializer implements PrimitiveSerializer<UpdatePlaylistUserDto> {
  @override
  final Iterable<Type> types = const [UpdatePlaylistUserDto, _$UpdatePlaylistUserDto];
