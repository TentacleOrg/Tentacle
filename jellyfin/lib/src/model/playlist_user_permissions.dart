...
@BuiltValue()
abstract class PlaylistUserPermissions implements Built<PlaylistUserPermissions, PlaylistUserPermissionsBuilder> {
  ...
  factory PlaylistUserPermissions([void updates(PlaylistUserPermissionsBuilder b)]) = _$PlaylistUserPermissions;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PlaylistUserPermissionsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PlaylistUserPermissions> get serializer => _$PlaylistUserPermissionsSerializer();
}

class _$PlaylistUserPermissionsSerializer implements PrimitiveSerializer<PlaylistUserPermissions> {
  @override
  final Iterable<Type> types = const [PlaylistUserPermissions, _$PlaylistUserPermissions];
