...
@BuiltValue()
abstract class SyncPlayQueueItem implements Built<SyncPlayQueueItem, SyncPlayQueueItemBuilder> {
  ...
  factory SyncPlayQueueItem([void updates(SyncPlayQueueItemBuilder b)]) = _$SyncPlayQueueItem;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SyncPlayQueueItemBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SyncPlayQueueItem> get serializer => _$SyncPlayQueueItemSerializer();
}

class _$SyncPlayQueueItemSerializer implements PrimitiveSerializer<SyncPlayQueueItem> {
  @override
