...
@BuiltValue()
abstract class LyricMetadata implements Built<LyricMetadata, LyricMetadataBuilder> {
  ...
  factory LyricMetadata([void updates(LyricMetadataBuilder b)]) = _$LyricMetadata;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(LyricMetadataBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<LyricMetadata> get serializer => _$LyricMetadataSerializer();
}
