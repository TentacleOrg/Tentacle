...
class PlaystateApi {
  ...
  Future<Response<void>> onPlaybackProgress({ 
    ...
    final _path = r'/PlayingItems/{itemId}/Progress'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> onPlaybackStart({ 
    ...
    final _path = r'/PlayingItems/{itemId}'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
