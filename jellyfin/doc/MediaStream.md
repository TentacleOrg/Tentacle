...
**videoRange** | [**VideoRange**](VideoRange.md) | Gets the video range. | [optional] 
**videoRangeType** | [**VideoRangeType**](VideoRangeType.md) | Gets the video range type. | [optional] 
**videoDoViTitle** | **String** | Gets the video dovi title. | [optional] 
**audioSpatialFormat** | [**AudioSpatialFormat**](AudioSpatialFormat.md) | Gets the audio spatial format. | [optional] 
