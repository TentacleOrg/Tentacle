...
class TranscodingProfile {
  ...
  TranscodingProfile({
    ...
    this.transcodeSeekInfo = const ._(Auto),
    this.copyTimestamps = false,
    this.context = const ._(Streaming),
  ...
  static TranscodingProfile? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return TranscodingProfile(
        ...
        transcodeSeekInfo: TranscodeSeekInfo.fromJson(json[r'TranscodeSeekInfo']) ?? Auto,
        copyTimestamps: mapValueOfType<bool>(json, r'CopyTimestamps') ?? false,
        context: EncodingContext.fromJson(json[r'Context']) ?? Streaming,
