...
class SessionInfoNowViewingItem {
  /// Returns a new [SessionInfoNowViewingItem] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SessionInfoNowViewingItem &&
     other.name == name &&
  ...
  /// Returns a new [SessionInfoNowViewingItem] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SessionInfoNowViewingItem? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SessionInfoNowViewingItem[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SessionInfoNowViewingItem[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return SessionInfoNowViewingItem(
  ...
  static List<SessionInfoNowViewingItem>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SessionInfoNowViewingItem>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SessionInfoNowViewingItem.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SessionInfoNowViewingItem> mapFromJson(dynamic json) {
    final map = <String, SessionInfoNowViewingItem>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SessionInfoNowViewingItem.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SessionInfoNowViewingItem-objects as value to a dart map
  static Map<String, List<SessionInfoNowViewingItem>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SessionInfoNowViewingItem>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SessionInfoNowViewingItem.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
