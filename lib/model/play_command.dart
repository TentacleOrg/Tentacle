...
class PlayCommand extends EnumClass {
  ...
  /// Enum PlayCommand.
  @BuiltValueEnumConst(wireName: "PlayNow")
  ...
  /// Enum PlayCommand.
  @BuiltValueEnumConst(wireName: "PlayLast")
  static const PlayCommand playLast = _$playLast;
  /// Enum PlayCommand.
  @BuiltValueEnumConst(wireName: "PlayInstantMix")
  static const PlayCommand playInstantMix = _$playInstantMix;
  /// Enum PlayCommand.
  @BuiltValueEnumConst(wireName: "PlayShuffle")
