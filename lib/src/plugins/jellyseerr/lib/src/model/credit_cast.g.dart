...
class _$CreditCast extends CreditCast {
  @override
  final num? id;
  @override
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'CreditCast')
          ..add('id', id)
...
class CreditCastBuilder implements Builder<CreditCast, CreditCastBuilder> {
  _$CreditCast? _$v;
  ...
  CreditCastBuilder() {
    CreditCast._defaults(this);
  }

  CreditCastBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void update(void Function(CreditCastBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  CreditCast build() => _build();
