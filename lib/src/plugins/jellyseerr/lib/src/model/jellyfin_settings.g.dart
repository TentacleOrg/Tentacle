...
class _$JellyfinSettings extends JellyfinSettings {
  ...
  @override
  final BuiltList<dynamic>? libraries;
  @override
...
class JellyfinSettingsBuilder
  ...
  ListBuilder<dynamic>? _libraries;
  ListBuilder<dynamic> get libraries =>
      _$this._libraries ??= new ListBuilder<dynamic>();
  set libraries(ListBuilder<dynamic>? libraries) =>
