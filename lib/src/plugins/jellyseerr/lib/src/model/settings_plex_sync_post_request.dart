...
/// * [start]
@BuiltValue()
abstract class SettingsPlexSyncPostRequest
    implements
        Built<SettingsPlexSyncPostRequest, SettingsPlexSyncPostRequestBuilder> {
  ...
  factory SettingsPlexSyncPostRequest(
          [void updates(SettingsPlexSyncPostRequestBuilder b)]) =
      _$SettingsPlexSyncPostRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SettingsPlexSyncPostRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SettingsPlexSyncPostRequest> get serializer =>
      _$SettingsPlexSyncPostRequestSerializer();
}

class _$SettingsPlexSyncPostRequestSerializer
    implements PrimitiveSerializer<SettingsPlexSyncPostRequest> {
  @override
