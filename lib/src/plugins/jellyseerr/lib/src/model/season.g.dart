...
class _$Season extends Season {
  ...
  @override
  final BuiltList<dynamic>? episodes;
...
class SeasonBuilder implements Builder<Season, SeasonBuilder> {
  ...
  ListBuilder<dynamic>? _episodes;
  ListBuilder<dynamic> get episodes =>
      _$this._episodes ??= new ListBuilder<dynamic>();
  set episodes(ListBuilder<dynamic>? episodes) => _$this._episodes = episodes;
