...
class _$TvDetails extends TvDetails {
  @override
  final num? id;
  @override
  ...
  @override
  final BuiltList<TvDetailsCreatedByInner>? createdBy;
  @override
  final BuiltList<num>? episodeRunTime;
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is TvDetails &&
        ...
        numberOfSeason == other.numberOfSeason &&
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, contentRatings.hashCode);
    ...
    _$hash = $jc(_$hash, lastEpisodeToAir.hashCode);
    _$hash = $jc(_$hash, name.hashCode);
    _$hash = $jc(_$hash, nextEpisodeToAir.hashCode);
    _$hash = $jc(_$hash, networks.hashCode);
    _$hash = $jc(_$hash, numberOfEpisodes.hashCode);
    _$hash = $jc(_$hash, numberOfSeason.hashCode);
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'TvDetails')
          ..add('id', id)
          ...
          ..add('numberOfSeason', numberOfSeason)
...
class TvDetailsBuilder implements Builder<TvDetails, TvDetailsBuilder> {
  _$TvDetails? _$v;
  ...
  num? get numberOfEpisodes => _$this._numberOfEpisodes;
  set numberOfEpisodes(num? numberOfEpisodes) =>
      _$this._numberOfEpisodes = numberOfEpisodes;

  num? _numberOfSeason;
  num? get numberOfSeason => _$this._numberOfSeason;
  set numberOfSeason(num? numberOfSeason) =>
      _$this._numberOfSeason = numberOfSeason;
  ...
  TvDetailsBuilder() {
    TvDetails._defaults(this);
  }

  TvDetailsBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
      _backdropPath = $v.backdropPath;
      _posterPath = $v.posterPath;
      _contentRatings = $v.contentRatings?.toBuilder();
      ...
      _lastEpisodeToAir = $v.lastEpisodeToAir?.toBuilder();
      _name = $v.name;
      _nextEpisodeToAir = $v.nextEpisodeToAir?.toBuilder();
      _networks = $v.networks?.toBuilder();
      _numberOfEpisodes = $v.numberOfEpisodes;
      _numberOfSeason = $v.numberOfSeason;
  ...
  @override
  void update(void Function(TvDetailsBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  TvDetails build() => _build();
  ...
  _$TvDetails _build() {
    ...
    try {
      ...
      try {
        _$failedField = 'contentRatings';
        _contentRatings?.build();
