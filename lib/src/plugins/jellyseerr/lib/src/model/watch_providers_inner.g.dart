...
class _$WatchProvidersInner extends WatchProvidersInner {
  ...
  final String? link;
  @override
  final BuiltList<dynamic>? buy;
  @override
  final BuiltList<dynamic>? flatrate;
...
class WatchProvidersInnerBuilder
  ...
  ListBuilder<dynamic>? _buy;
  ListBuilder<dynamic> get buy => _$this._buy ??= new ListBuilder<dynamic>();
  set buy(ListBuilder<dynamic>? buy) => _$this._buy = buy;

  ListBuilder<dynamic>? _flatrate;
  ListBuilder<dynamic> get flatrate =>
      _$this._flatrate ??= new ListBuilder<dynamic>();
  set flatrate(ListBuilder<dynamic>? flatrate) => _$this._flatrate = flatrate;
