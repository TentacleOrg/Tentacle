...
part of 'credit_crew.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$CreditCrew extends CreditCrew {
  @override
  final num? id;
  @override
  ...
  factory _$CreditCrew([void Function(CreditCrewBuilder)? updates]) =>
      (CreditCrewBuilder()..update(updates))._build();
  ...
  _$CreditCrew._(
      ...
      : super._();
  @override
  CreditCrew rebuild(void Function(CreditCrewBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  CreditCrewBuilder toBuilder() => CreditCrewBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is CreditCrew &&
        id == other.id &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'CreditCrew')
          ..add('id', id)
...
class CreditCrewBuilder implements Builder<CreditCrew, CreditCrewBuilder> {
  _$CreditCrew? _$v;
  ...
  CreditCrewBuilder() {
    CreditCrew._defaults(this);
  }

  CreditCrewBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
  ...
  @override
  void replace(CreditCrew other) {
    _$v = other as _$CreditCrew;
  }

  @override
  void update(void Function(CreditCrewBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  CreditCrew build() => _build();

  _$CreditCrew _build() {
    _$CreditCrew _$result;
    try {
      _$result = _$v ??
          _$CreditCrew._(
            id: id,
      ...
      try {
        ...
        throw BuiltValueNestedFieldError(
            r'CreditCrew', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
