...
class CollectionBuilder implements Builder<Collection, CollectionBuilder> {
  ...
  ListBuilder<dynamic>? _parts;
  ListBuilder<dynamic> get parts =>
      _$this._parts ??= new ListBuilder<dynamic>();
  set parts(ListBuilder<dynamic>? parts) => _$this._parts = parts;
