...
/// * [mediaInfo]
@BuiltValue()
abstract class CreditCast implements Built<CreditCast, CreditCastBuilder> {
  ...
  factory CreditCast([void updates(CreditCastBuilder b)]) = _$CreditCast;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreditCastBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CreditCast> get serializer => _$CreditCastSerializer();
}

class _$CreditCastSerializer implements PrimitiveSerializer<CreditCast> {
  @override
  final Iterable<Type> types = const [CreditCast, _$CreditCast];

  @override
  final String wireName = r'CreditCast';
  ...
  void _deserializeProperties(
    ...
    required CreditCastBuilder result,
  ...
  @override
  CreditCast deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CreditCastBuilder();
