...
class SystemApi {
  ...
  Future<Response<ActivityLogEntryQueryResult>> getLogEntries({
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (maxDate != null)
        r'maxDate': encodeQueryParameter(
            _serializers, maxDate, const FullType(DateTime)),
      if (hasUserId != null)
        r'hasUserId':
      ...
      if (overview != null)
        r'overview': encodeQueryParameter(
            _serializers, overview, const FullType(String)),
      if (shortOverview != null)
        r'shortOverview': encodeQueryParameter(
            _serializers, shortOverview, const FullType(String)),
      if (type != null)
        r'type':
      ...
      if (severity != null)
        r'severity': encodeQueryParameter(
            _serializers, severity, const FullType(LogLevel)),
      if (sortBy != null)
        r'sortBy': encodeCollectionQueryParameter<ActivityLogSortBy>(
          _serializers,
          sortBy,
