...
class LibraryApi {
  ...
  Future<Response<ItemCounts>> getItemCounts({ 
    ...
    try {
      const _responseType = FullType(ItemCounts);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as ItemCounts;
  ...
  Future<Response<LibraryOptionsResultDto>> getLibraryOptionsInfo({ 
    ...
    try {
      const _responseType = FullType(LibraryOptionsResultDto);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
  ...
  Future<Response<AllThemeMediaResult>> getThemeMedia({ 
    ...
    try {
      const _responseType = FullType(AllThemeMediaResult);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
  ...
  Future<Response<ThemeMediaResult>> getThemeSongs({ 
    ...
    try {
      const _responseType = FullType(ThemeMediaResult);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as ThemeMediaResult;
  ...
  ///
  /// Parameters:
  /// * [postUpdatedMediaRequest] - The update paths.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<void>> postUpdatedMedia({ 
    required PostUpdatedMediaRequest postUpdatedMediaRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(PostUpdatedMediaRequest);
      _bodyData = _serializers.serialize(postUpdatedMediaRequest, specifiedType: _type);
