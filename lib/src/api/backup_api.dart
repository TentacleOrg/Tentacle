...
class BackupApi {
  ...
  Future<Response<BackupManifestDto>> createBackup({
    ...
    try {
      ...
      _bodyData = backupOptionsDto == null
          ? null
          : _serializers.serialize(backupOptionsDto, specifiedType: _type);
  ...
  Future<Response<void>> startRestoreBackup({
    ...
    try {
      ...
      _bodyData =
          _serializers.serialize(backupRestoreRequestDto, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
