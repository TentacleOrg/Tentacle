...
import 'package:openapi/src/api/kodi_sync_queue_api.dart';
...
import 'package:openapi/src/api/open_subtitles_api.dart';
import 'package:openapi/src/api/package_api.dart';
import 'package:openapi/src/api/persons_api.dart';
import 'package:openapi/src/api/playback_reporting_activity_api.dart';
...
class Openapi {
  static const String basePath = r'https://jpuerto.ddns.net/jellyfin';
