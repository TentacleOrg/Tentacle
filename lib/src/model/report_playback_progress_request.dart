...
part 'report_playback_progress_request.g.dart';
...
/// * [playlistItemId] 
@BuiltValue()
abstract class ReportPlaybackProgressRequest implements PlaybackProgressInfo, Built<ReportPlaybackProgressRequest, ReportPlaybackProgressRequestBuilder> {
  ReportPlaybackProgressRequest._();

  factory ReportPlaybackProgressRequest([void updates(ReportPlaybackProgressRequestBuilder b)]) = _$ReportPlaybackProgressRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ReportPlaybackProgressRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ReportPlaybackProgressRequest> get serializer => _$ReportPlaybackProgressRequestSerializer();
}

class _$ReportPlaybackProgressRequestSerializer implements PrimitiveSerializer<ReportPlaybackProgressRequest> {
  @override
  final Iterable<Type> types = const [ReportPlaybackProgressRequest, _$ReportPlaybackProgressRequest];

  @override
  final String wireName = r'ReportPlaybackProgressRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ReportPlaybackProgressRequest object, {
  ...
  void _deserializeProperties(
    ...
    required ReportPlaybackProgressRequestBuilder result,
  ...
  @override
  ReportPlaybackProgressRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ReportPlaybackProgressRequestBuilder();
