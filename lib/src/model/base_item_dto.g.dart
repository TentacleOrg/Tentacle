...
class BaseItemDtoBuilder implements Builder<BaseItemDto, BaseItemDtoBuilder> {
  _$BaseItemDto? _$v;
  ...
  set extraType(ExtraType? extraType) => _$this._extraType = extraType;
  ...
  set canDownload(bool? canDownload) => _$this._canDownload = canDownload;

  bool? _hasLyrics;
  bool? get hasLyrics => _$this._hasLyrics;
  set hasLyrics(bool? hasLyrics) => _$this._hasLyrics = hasLyrics;

  bool? _hasSubtitles;
  bool? get hasSubtitles => _$this._hasSubtitles;
  set hasSubtitles(bool? hasSubtitles) => _$this._hasSubtitles = hasSubtitles;
  ...
  set criticRating(double? criticRating) => _$this._criticRating = criticRating;
  ...
  set customRating(String? customRating) => _$this._customRating = customRating;
  ...
  set playAccess(PlayAccess? playAccess) => _$this._playAccess = playAccess;
  ...
  set isHD(bool? isHD) => _$this._isHD = isHD;
  ...
  set displayOrder(String? displayOrder) => _$this._displayOrder = displayOrder;
  ...
  set seriesStudio(String? seriesStudio) => _$this._seriesStudio = seriesStudio;
  ...
  set lockData(bool? lockData) => _$this._lockData = lockData;
  ...
  set cameraMake(String? cameraMake) => _$this._cameraMake = cameraMake;

  String? _cameraModel;
  String? get cameraModel => _$this._cameraModel;
  set cameraModel(String? cameraModel) => _$this._cameraModel = cameraModel;
  ...
  set focalLength(double? focalLength) => _$this._focalLength = focalLength;
  ...
  set aperture(double? aperture) => _$this._aperture = aperture;

  double? _shutterSpeed;
  double? get shutterSpeed => _$this._shutterSpeed;
  set shutterSpeed(double? shutterSpeed) => _$this._shutterSpeed = shutterSpeed;
  ...
  set episodeTitle(String? episodeTitle) => _$this._episodeTitle = episodeTitle;
  ...
  set audio(ProgramAudio? audio) => _$this._audio = audio;
  ...
  set isPremiere(bool? isPremiere) => _$this._isPremiere = isPremiere;
