...
part 'update_user_policy_request.g.dart';
...
@BuiltValue()
abstract class UpdateUserPolicyRequest implements UserPolicy, Built<UpdateUserPolicyRequest, UpdateUserPolicyRequestBuilder> {
  UpdateUserPolicyRequest._();

  factory UpdateUserPolicyRequest([void updates(UpdateUserPolicyRequestBuilder b)]) = _$UpdateUserPolicyRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpdateUserPolicyRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpdateUserPolicyRequest> get serializer => _$UpdateUserPolicyRequestSerializer();
}

class _$UpdateUserPolicyRequestSerializer implements PrimitiveSerializer<UpdateUserPolicyRequest> {
  @override
  final Iterable<Type> types = const [UpdateUserPolicyRequest, _$UpdateUserPolicyRequest];

  @override
  final String wireName = r'UpdateUserPolicyRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UpdateUserPolicyRequest object, {
  ...
  void _deserializeProperties(
    ...
    required UpdateUserPolicyRequestBuilder result,
  ...
  @override
  UpdateUserPolicyRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UpdateUserPolicyRequestBuilder();
