...
abstract class SessionInfoNowPlayingItem
    implements
        BaseItemDto,
        Built<SessionInfoNowPlayingItem, SessionInfoNowPlayingItemBuilder> {
  SessionInfoNowPlayingItem._();

  factory SessionInfoNowPlayingItem(
          [void updates(SessionInfoNowPlayingItemBuilder b)]) =
      _$SessionInfoNowPlayingItem;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SessionInfoNowPlayingItemBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SessionInfoNowPlayingItem> get serializer =>
      _$SessionInfoNowPlayingItemSerializer();
}

class _$SessionInfoNowPlayingItemSerializer
    implements PrimitiveSerializer<SessionInfoNowPlayingItem> {
  @override
