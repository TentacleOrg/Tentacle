...
@BuiltValue()
abstract class BackupOptionsDto
    implements Built<BackupOptionsDto, BackupOptionsDtoBuilder> {
  ...
  factory BackupOptionsDto([void updates(BackupOptionsDtoBuilder b)]) =
      _$BackupOptionsDto;
  ...
  static Serializer<BackupOptionsDto> get serializer =>
      _$BackupOptionsDtoSerializer();
}

class _$BackupOptionsDtoSerializer
    implements PrimitiveSerializer<BackupOptionsDto> {
  @override
