...
@BuiltValue()
abstract class SyncPlayNotInGroupUpdate
    implements
        Built<SyncPlayNotInGroupUpdate, SyncPlayNotInGroupUpdateBuilder> {
  ...
  factory SyncPlayNotInGroupUpdate(
          [void updates(SyncPlayNotInGroupUpdateBuilder b)]) =
  ...
  static Serializer<SyncPlayNotInGroupUpdate> get serializer =>
      _$SyncPlayNotInGroupUpdateSerializer();
}

class _$SyncPlayNotInGroupUpdateSerializer
    implements PrimitiveSerializer<SyncPlayNotInGroupUpdate> {
  @override
