...
part 'series_info_remote_search_query_search_info.g.dart';
...
/// * [isAutomated] 
@BuiltValue()
abstract class SeriesInfoRemoteSearchQuerySearchInfo implements SeriesInfo, Built<SeriesInfoRemoteSearchQuerySearchInfo, SeriesInfoRemoteSearchQuerySearchInfoBuilder> {
  SeriesInfoRemoteSearchQuerySearchInfo._();

  factory SeriesInfoRemoteSearchQuerySearchInfo([void updates(SeriesInfoRemoteSearchQuerySearchInfoBuilder b)]) = _$SeriesInfoRemoteSearchQuerySearchInfo;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SeriesInfoRemoteSearchQuerySearchInfoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SeriesInfoRemoteSearchQuerySearchInfo> get serializer => _$SeriesInfoRemoteSearchQuerySearchInfoSerializer();
}

class _$SeriesInfoRemoteSearchQuerySearchInfoSerializer implements PrimitiveSerializer<SeriesInfoRemoteSearchQuerySearchInfo> {
  @override
  final Iterable<Type> types = const [SeriesInfoRemoteSearchQuerySearchInfo, _$SeriesInfoRemoteSearchQuerySearchInfo];

  @override
  final String wireName = r'SeriesInfoRemoteSearchQuerySearchInfo';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SeriesInfoRemoteSearchQuerySearchInfo object, {
  ...
  void _deserializeProperties(
    ...
    required SeriesInfoRemoteSearchQuerySearchInfoBuilder result,
  ...
  @override
  SeriesInfoRemoteSearchQuerySearchInfo deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SeriesInfoRemoteSearchQuerySearchInfoBuilder();
