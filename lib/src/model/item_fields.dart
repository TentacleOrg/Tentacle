...
class ItemFields extends EnumClass {
  ...
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'CanDelete')
  static const ItemFields canDelete = _$canDelete;
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'CanDownload')
  static const ItemFields canDownload = _$canDownload;
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'ChannelInfo')
  ...
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'CumulativeRunTimeTicks')
  static const ItemFields cumulativeRunTimeTicks = _$cumulativeRunTimeTicks;
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'CustomRating')
  ...
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'DateLastMediaAdded')
  static const ItemFields dateLastMediaAdded = _$dateLastMediaAdded;
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'DisplayPreferencesId')
  static const ItemFields displayPreferencesId = _$displayPreferencesId;
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'Etag')
  static const ItemFields etag = _$etag;
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'ExternalUrls')
  ...
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'MediaSourceCount')
  static const ItemFields mediaSourceCount = _$mediaSourceCount;
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'MediaSources')
  ...
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'ParentId')
  ...
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'PlayAccess')
  ...
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'ProviderIds')
  static const ItemFields providerIds = _$providerIds;
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'PrimaryImageAspectRatio')
  static const ItemFields primaryImageAspectRatio = _$primaryImageAspectRatio;
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'RecursiveItemCount')
  ...
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'SpecialEpisodeNumbers')
  ...
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'RemoteTrailers')
  static const ItemFields remoteTrailers = _$remoteTrailers;
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'MediaStreams')
  ...
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'DateLastSaved')
  static const ItemFields dateLastSaved = _$dateLastSaved;
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'RefreshState')
  static const ItemFields refreshState = _$refreshState;
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'ChannelImage')
  static const ItemFields channelImage = _$channelImage;
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'EnableMediaSourceDisplay')
  ...
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'ExtraIds')
  static const ItemFields extraIds = _$extraIds;
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'LocalTrailerCount')
  static const ItemFields localTrailerCount = _$localTrailerCount;
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'IsHD')
  static const ItemFields isHD = _$isHD;
  /// Used to control the data that gets attached to DtoBaseItems.
  @BuiltValueEnumConst(wireName: r'SpecialFeatureCount')
