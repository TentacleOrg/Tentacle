...
@BuiltValue()
abstract class ParentalRatingScore
    implements Built<ParentalRatingScore, ParentalRatingScoreBuilder> {
  ...
  factory ParentalRatingScore([void updates(ParentalRatingScoreBuilder b)]) =
      _$ParentalRatingScore;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ParentalRatingScoreBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ParentalRatingScore> get serializer =>
      _$ParentalRatingScoreSerializer();
}

class _$ParentalRatingScoreSerializer
    implements PrimitiveSerializer<ParentalRatingScore> {
  @override
