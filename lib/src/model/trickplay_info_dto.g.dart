...
class _$TrickplayInfoDto extends TrickplayInfoDto {
  @override
  final int? width;
  @override
  final int? height;
  ...
  factory _$TrickplayInfoDto(
          [void Function(TrickplayInfoDtoBuilder)? updates]) =>
      (TrickplayInfoDtoBuilder()..update(updates))._build();

  _$TrickplayInfoDto._(
      {this.width,
      this.height,
      this.tileWidth,
      this.tileHeight,
      ...
      : super._();
  @override
  TrickplayInfoDto rebuild(void Function(TrickplayInfoDtoBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  TrickplayInfoDtoBuilder toBuilder() =>
      TrickplayInfoDtoBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is TrickplayInfoDto &&
        width == other.width &&
        height == other.height &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'TrickplayInfoDto')
          ..add('width', width)
          ..add('height', height)
...
class TrickplayInfoDtoBuilder
    implements Builder<TrickplayInfoDto, TrickplayInfoDtoBuilder> {
  _$TrickplayInfoDto? _$v;
  ...
  TrickplayInfoDtoBuilder() {
    TrickplayInfoDto._defaults(this);
  }

  TrickplayInfoDtoBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _width = $v.width;
      _height = $v.height;
  ...
  @override
  void replace(TrickplayInfoDto other) {
    _$v = other as _$TrickplayInfoDto;
  }

  @override
  void update(void Function(TrickplayInfoDtoBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  TrickplayInfoDto build() => _build();

  _$TrickplayInfoDto _build() {
    final _$result = _$v ??
        _$TrickplayInfoDto._(
          width: width,
          height: height,
