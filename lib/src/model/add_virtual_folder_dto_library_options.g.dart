...
part of 'add_virtual_folder_dto_library_options.dart';
...
class _$AddVirtualFolderDtoLibraryOptions
  ...
  factory _$AddVirtualFolderDtoLibraryOptions(
          [void Function(AddVirtualFolderDtoLibraryOptionsBuilder)? updates]) =>
      (new AddVirtualFolderDtoLibraryOptionsBuilder()..update(updates))
          ._build();
  ...
  @override
  AddVirtualFolderDtoLibraryOptions rebuild(
          void Function(AddVirtualFolderDtoLibraryOptionsBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  AddVirtualFolderDtoLibraryOptionsBuilder toBuilder() =>
      new AddVirtualFolderDtoLibraryOptionsBuilder()..replace(this);
...
class AddVirtualFolderDtoLibraryOptionsBuilder
    implements
        Builder<AddVirtualFolderDtoLibraryOptions,
  ...
  AddVirtualFolderDtoLibraryOptionsBuilder() {
    AddVirtualFolderDtoLibraryOptions._defaults(this);
  }
  ...
  @override
  void replace(covariant AddVirtualFolderDtoLibraryOptions other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$AddVirtualFolderDtoLibraryOptions;
  }
  ...
  @override
  AddVirtualFolderDtoLibraryOptions build() => _build();

  _$AddVirtualFolderDtoLibraryOptions _build() {
    _$AddVirtualFolderDtoLibraryOptions _$result;
    try {
      _$result = _$v ??
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'AddVirtualFolderDtoLibraryOptions', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
