...
@BuiltValue()
abstract class OutboundWebSocketMessage
    implements
        Built<OutboundWebSocketMessage, OutboundWebSocketMessageBuilder> {
  ...
  factory OutboundWebSocketMessage(
          [void updates(OutboundWebSocketMessageBuilder b)]) =
      _$OutboundWebSocketMessage;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OutboundWebSocketMessageBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OutboundWebSocketMessage> get serializer =>
      _$OutboundWebSocketMessageSerializer();
}
...
extension OutboundWebSocketMessageBuilderDiscriminatorExt
    on OutboundWebSocketMessageBuilder {
  String? get discriminatorValue {
...
class _$OutboundWebSocketMessageSerializer
    implements PrimitiveSerializer<OutboundWebSocketMessage> {
  @override
  ...
  OutboundWebSocketMessage deserialize(
    ...
    final discIndex = serializedList
            .indexOf(OutboundWebSocketMessage.discriminatorFieldName) +
        1;
