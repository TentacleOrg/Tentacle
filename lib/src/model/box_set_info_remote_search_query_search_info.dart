...
part 'box_set_info_remote_search_query_search_info.g.dart';
...
/// * [isAutomated] 
@BuiltValue()
abstract class BoxSetInfoRemoteSearchQuerySearchInfo implements BoxSetInfo, Built<BoxSetInfoRemoteSearchQuerySearchInfo, BoxSetInfoRemoteSearchQuerySearchInfoBuilder> {
  BoxSetInfoRemoteSearchQuerySearchInfo._();

  factory BoxSetInfoRemoteSearchQuerySearchInfo([void updates(BoxSetInfoRemoteSearchQuerySearchInfoBuilder b)]) = _$BoxSetInfoRemoteSearchQuerySearchInfo;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BoxSetInfoRemoteSearchQuerySearchInfoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<BoxSetInfoRemoteSearchQuerySearchInfo> get serializer => _$BoxSetInfoRemoteSearchQuerySearchInfoSerializer();
}

class _$BoxSetInfoRemoteSearchQuerySearchInfoSerializer implements PrimitiveSerializer<BoxSetInfoRemoteSearchQuerySearchInfo> {
  @override
  final Iterable<Type> types = const [BoxSetInfoRemoteSearchQuerySearchInfo, _$BoxSetInfoRemoteSearchQuerySearchInfo];

  @override
  final String wireName = r'BoxSetInfoRemoteSearchQuerySearchInfo';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    BoxSetInfoRemoteSearchQuerySearchInfo object, {
  ...
  void _deserializeProperties(
    ...
    required BoxSetInfoRemoteSearchQuerySearchInfoBuilder result,
  ...
  @override
  BoxSetInfoRemoteSearchQuerySearchInfo deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BoxSetInfoRemoteSearchQuerySearchInfoBuilder();
