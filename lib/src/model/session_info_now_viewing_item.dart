...
/// * [currentProgram]
@BuiltValue()
abstract class SessionInfoNowViewingItem
    implements
        BaseItemDto,
        Built<SessionInfoNowViewingItem, SessionInfoNowViewingItemBuilder> {
  SessionInfoNowViewingItem._();

  factory SessionInfoNowViewingItem(
          [void updates(SessionInfoNowViewingItemBuilder b)]) =
      _$SessionInfoNowViewingItem;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SessionInfoNowViewingItemBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SessionInfoNowViewingItem> get serializer =>
      _$SessionInfoNowViewingItemSerializer();
}

class _$SessionInfoNowViewingItemSerializer
    implements PrimitiveSerializer<SessionInfoNowViewingItem> {
  @override
