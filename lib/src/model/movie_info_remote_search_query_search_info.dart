...
part 'movie_info_remote_search_query_search_info.g.dart';
...
/// * [isAutomated] 
@BuiltValue()
abstract class MovieInfoRemoteSearchQuerySearchInfo implements MovieInfo, Built<MovieInfoRemoteSearchQuerySearchInfo, MovieInfoRemoteSearchQuerySearchInfoBuilder> {
  MovieInfoRemoteSearchQuerySearchInfo._();

  factory MovieInfoRemoteSearchQuerySearchInfo([void updates(MovieInfoRemoteSearchQuerySearchInfoBuilder b)]) = _$MovieInfoRemoteSearchQuerySearchInfo;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MovieInfoRemoteSearchQuerySearchInfoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<MovieInfoRemoteSearchQuerySearchInfo> get serializer => _$MovieInfoRemoteSearchQuerySearchInfoSerializer();
}

class _$MovieInfoRemoteSearchQuerySearchInfoSerializer implements PrimitiveSerializer<MovieInfoRemoteSearchQuerySearchInfo> {
  @override
  final Iterable<Type> types = const [MovieInfoRemoteSearchQuerySearchInfo, _$MovieInfoRemoteSearchQuerySearchInfo];

  @override
  final String wireName = r'MovieInfoRemoteSearchQuerySearchInfo';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    MovieInfoRemoteSearchQuerySearchInfo object, {
  ...
  void _deserializeProperties(
    ...
    required MovieInfoRemoteSearchQuerySearchInfoBuilder result,
  ...
  @override
  MovieInfoRemoteSearchQuerySearchInfo deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = MovieInfoRemoteSearchQuerySearchInfoBuilder();
