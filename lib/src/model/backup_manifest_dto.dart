...
@BuiltValue()
abstract class BackupManifestDto
  ...
  factory BackupManifestDto([void updates(BackupManifestDtoBuilder b)]) =
      _$BackupManifestDto;
  ...
  static Serializer<BackupManifestDto> get serializer =>
      _$BackupManifestDtoSerializer();
}

class _$BackupManifestDtoSerializer
    implements PrimitiveSerializer<BackupManifestDto> {
  @override
