...
part of 'session_info_now_viewing_item.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$SessionInfoNowViewingItem extends SessionInfoNowViewingItem {
  @override
  final String? name;
  @override
  ...
  factory _$SessionInfoNowViewingItem(
          [void Function(SessionInfoNowViewingItemBuilder)? updates]) =>
      (new SessionInfoNowViewingItemBuilder()..update(updates))._build();

  _$SessionInfoNowViewingItem._(
      {this.name,
      this.originalTitle,
      this.serverId,
      this.id,
  ...
  @override
  SessionInfoNowViewingItem rebuild(
          void Function(SessionInfoNowViewingItemBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  SessionInfoNowViewingItemBuilder toBuilder() =>
      new SessionInfoNowViewingItemBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is SessionInfoNowViewingItem &&
        name == other.name &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'SessionInfoNowViewingItem')
          ..add('name', name)
...
class SessionInfoNowViewingItemBuilder
    implements
        Builder<SessionInfoNowViewingItem, SessionInfoNowViewingItemBuilder>,
        BaseItemDtoBuilder {
  _$SessionInfoNowViewingItem? _$v;
  ...
  SessionInfoNowViewingItemBuilder() {
    SessionInfoNowViewingItem._defaults(this);
  }

  SessionInfoNowViewingItemBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _name = $v.name;
  ...
  @override
  void replace(covariant SessionInfoNowViewingItem other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$SessionInfoNowViewingItem;
  }

  @override
  void update(void Function(SessionInfoNowViewingItemBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  SessionInfoNowViewingItem build() => _build();

  _$SessionInfoNowViewingItem _build() {
    _$SessionInfoNowViewingItem _$result;
    try {
      _$result = _$v ??
          new _$SessionInfoNowViewingItem._(
              name: name,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'SessionInfoNowViewingItem', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
