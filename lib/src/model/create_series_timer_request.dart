...
part 'create_series_timer_request.g.dart';
...
@BuiltValue()
abstract class CreateSeriesTimerRequest implements SeriesTimerInfoDto, Built<CreateSeriesTimerRequest, CreateSeriesTimerRequestBuilder> {
  CreateSeriesTimerRequest._();

  factory CreateSeriesTimerRequest([void updates(CreateSeriesTimerRequestBuilder b)]) = _$CreateSeriesTimerRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreateSeriesTimerRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CreateSeriesTimerRequest> get serializer => _$CreateSeriesTimerRequestSerializer();
}

class _$CreateSeriesTimerRequestSerializer implements PrimitiveSerializer<CreateSeriesTimerRequest> {
  @override
  final Iterable<Type> types = const [CreateSeriesTimerRequest, _$CreateSeriesTimerRequest];

  @override
  final String wireName = r'CreateSeriesTimerRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CreateSeriesTimerRequest object, {
  ...
  void _deserializeProperties(
    ...
    required CreateSeriesTimerRequestBuilder result,
  ...
  @override
  CreateSeriesTimerRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CreateSeriesTimerRequestBuilder();
