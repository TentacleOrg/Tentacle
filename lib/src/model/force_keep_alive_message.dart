...
@BuiltValue()
abstract class ForceKeepAliveMessage
    implements Built<ForceKeepAliveMessage, ForceKeepAliveMessageBuilder> {
  ...
  factory ForceKeepAliveMessage(
      [void updates(ForceKeepAliveMessageBuilder b)]) = _$ForceKeepAliveMessage;
  ...
  static Serializer<ForceKeepAliveMessage> get serializer =>
      _$ForceKeepAliveMessageSerializer();
}

class _$ForceKeepAliveMessageSerializer
    implements PrimitiveSerializer<ForceKeepAliveMessage> {
  @override
  final Iterable<Type> types = const [
    ForceKeepAliveMessage,
    _$ForceKeepAliveMessage
  ];
