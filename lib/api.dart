...
part 'api/kodi_sync_queue_api.dart';
...
part 'api/open_subtitles_api.dart';
part 'api/package_api.dart';
part 'api/persons_api.dart';
part 'api/playback_reporting_activity_api.dart';
...
part 'model/client_capabilities_dto_device_profile.dart';
...
part 'model/custom_query_data.dart';
part 'model/custom_query_request.dart';
...
part 'model/login_info_input.dart';
...
part 'model/report_playback_options.dart';
...
part 'model/server_time_info.dart';
...
part 'model/sync_update_info.dart';
...
part 'model/transcode_reason.dart';
...
part 'model/validate_login_info_request.dart';
