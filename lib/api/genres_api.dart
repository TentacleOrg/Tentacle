...
class GenresApi {
    ...
    GenresApi(this._dio, this._serializers);

        /// Gets a genre, by name.
        ///
        /// 
        Future<Response<BaseItemDto>>getGenre(String genreName,{ String userId,CancelToken cancelToken, Map<String, String> headers,}) async {

        String _path = "/Genres/{genreName}".replaceAll("{" r'genreName' "}", genreName.toString());
